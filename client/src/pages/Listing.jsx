  ...
  return (
    <main>
        ...
        {listing && !loading &&!error && (
            ...
            <div
            className='fixed top-[23%] right-[3%] z-10 border rounded-full w-12 h-12 flex 
            justify-center items-center bg-slate-100 cursor-pointer'
            >
                <FaShare 
                onClick={()=>{
                ...
                { copied && (
                <p 
                className='fixed top-[24%] right-[8%] z-10 rounded-md bg-slate-100 p-2'>
                    Link Copied
                </p>
                )}
            </div>
